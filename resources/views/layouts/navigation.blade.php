            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('me.simpanan')" wire:navigate>
                                {{ __('Simpanan Saya') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('me.pinjaman')" wire:navigate>
                                {{ __('Pinjaman Saya') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('me.angsuran')" wire:navigate>
                                {{ __('Angsuran Saya') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('me.cashout')" wire:navigate>
                                {{ __('Pengajuan Cash Out') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                </div>
