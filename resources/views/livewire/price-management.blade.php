                                ...
                                @forelse($sellingPrices as $price)
                                    <tr>
                                        ...
                                        <td class="px-2 py-1 text-right">
                                            @if($showDeleteConfirmation && $priceIdToDelete === $price->selling_id)
                                                <x-secondary-button wire:click="cancelDelete" class="btn-sm">Batal</x-secondary-button>
                                                <x-danger-button wire:click="destroyConfirmedPrice" class="btn-sm">Ya, Hapus</x-danger-button>
                                            @else
                                                <x-secondary-button wire:click="editSellingPrice({{ $price->selling_id }})" class="btn-sm">Edit</x-secondary-button>
                                                <x-danger-button wire:click="confirmDelete({{ $price->selling_id }})" class="btn-sm">Hapus</x-danger-button>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
